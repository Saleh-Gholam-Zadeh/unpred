...
def plot_clustering(z_run, labels, components=2, engine ='plotly', download = False, folder_name =None, exp_name = 'trial', wandb_run=None):
    ...
    :return:
    """
    print('latentvis.py line 27 plot_clustering()func is called')
    def plot_clustering_plotly(z_run, labels):
        print('latentvis.py line 29 plot_clustering_plotly() func is called')
    ...
    def plot_clustering_matplotlib(z_run, labels, download=False, folder_name=None, exp_name='trial'):
        print('latentvis.py line 112 plot_clustering_matplotlib() func is called')
        ...
        if components==2:
            print("z_run_pca.shape = ",z_run_pca.shape)
            print("labels.shape:",labels.shape)#saleh_added
        ...
        print('line 153 latentVis.py')
        print(folder_name + "/pca_" + exp_name +".png")
        if download:
        ...
        if download:
            ...
            print(folder_name + "/tsne_" + exp_name +".png")
        else:
            print(folder_name + "/tsne_" + exp_name + ".png")
            plt.savefig(folder_name + "/tsne_" + exp_name + ".png")
    ...
    if (download == False) & (engine == 'plotly'):
        print("line 229 latentVis.py engine == plotly")
        plot_clustering_plotly(z_run, labels)
    if (download) & (engine == 'plotly'):
        print("line 232 latentVis.py engine == plotly")

        print("Can't download plotly plots")
    if engine == 'matplotlib':
        print("line 236 latentVis.py engine == matplotlib")
