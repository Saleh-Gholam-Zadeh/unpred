...
class Experiment():
    def __init__(self, cfg):
        ...
        self.all_flows = ['flow_249','flow_259','flow_296','flow_773','flow_859','flow_864','flow_869','flow_872','flow_924','flow_966','flow_1046','flow_1066','flow_1117']
    ...
    def _experiment(self,flow=None):
        ...
        #load_dir = os.path.join(os.getcwd(),'experiments','saved_models_MLP_plus')
        load_dir = os.path.join(os.getcwd(),'experiments','saved_models_MLP_plus_mae')
        pattern = "MLP_plus*"+str(key) +"_0.712M.ckpt"
        ...
        ##### Define WandB Stuffs
        expname = cfg.wandb.exp_name + "_MLP_plus"
        try:
        ...
        for key , inner_dict in test_dict.items():
            ...
            #output_dir = os.path.join(os.getcwd(),'experiments','residuals','MLP_plus')
            output_dir = os.path.join(os.getcwd(),'experiments','residuals','MLP_plus_mae')

            # f_name = os.path.join(output_dir,'MLP_plus_tr_' + str(key) + '.pickle')
            ...
            #
            # f_name = os.path.join(output_dir, 'MLP_plus_te_' + str(key) + '.pickle')
            ...
            f_name = os.path.join(output_dir,'MLP_plus_mae_tr_' + str(key) + '.pickle')
            with open(f_name, 'wb') as handle7:
                pickle.dump(window_with_residual_tr_denorm, handle7, protocol=pickle.HIGHEST_PROTOCOL)
                print("train_res_"+str(key)+" saved")

            f_name = os.path.join(output_dir, 'MLP_plus_mae_te_' + str(key) + '.pickle')
            with open(f_name, 'wb') as handle8:
                pickle.dump(window_with_residual_te_denorm, handle8, protocol=pickle.HIGHEST_PROTOCOL)
                print("test_res_"+str(key)+" saved")
