...
class Experiment():
    ...
    def _experiment(self,flow=None):
        ...
        model_name = 'mlp_plus_mae_remained_from_NST'
        ...
        if cfg.data_reader.load:
            ...
            # with open('chi_square_residual_dict_MLP_plus.pickle', 'rb') as file8:
        ...
        for j,key in enumerate(right_keys):
            ...
            plot_name = key + "_MLP_1step_ahead_prediction_right_side.png"
        ...
        for i,key in enumerate(left_keys):
            ...
            plot_name = key + "_MLP_1step_ahead_prediction_left_side.png"
