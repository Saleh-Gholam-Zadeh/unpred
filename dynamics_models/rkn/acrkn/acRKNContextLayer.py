...
from dynamics_models.rkn_cell.kalman_ops.update import Update
from dynamics_models.rkn_cell.kalman_ops.contextual_predict import AcPredict
...
class AcRKNContextLayer(nn.Module):
    ...
    def __init__(self, ltd, latent_obs_dim, act_dim, config=None, dtype=torch.float32,
